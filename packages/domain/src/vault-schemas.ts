...
export const PasswordHistorySchema = z
  .object({
...
export const VaultFieldSchema = z
  .object({
...
export const TrashVaultItemSchema = z
  .object({
...
export const UpdateCredentialPayloadSchema = z
  .object({
...
export const AutofillSuggestionPayloadSchema = z
  .object({
...
export const AddActionPayloadSchema = z
  .object({
    actionType: z.literal("add"),
    domain: z.string(),
    username: z.string(),
  ...
  .readonly();
export const UpdateActionPayloadSchema = z
  .object({
    actionType: z.literal("update"),
    domain: z.string(),
    username: z.string(),
...
export const CheckAutofillSuggestionMsgSchema = z
  .object({
...
export const CheckPendingNotificationMsgSchema = z
  .object({
...
export const CredentialsSubmittedMsgSchema = z
  .object({
...
export const SaveCredentialActionMsgSchema = z
  .object({
...
export const SaveCredentialActionResponseSchema = z
  .object({
    success: z.boolean(),
  })
  .readonly();
...
export const UserActivityMsgSchema = z
  .object({
