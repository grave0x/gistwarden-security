...
1. **[`apps/extension/src/extension/autofill-core.ts`](../../apps/extension/src/extension/autofill-core.ts)**:
...
3. **[`packages/domain/src/vault-domain-matching.ts`](../../packages/domain/src/vault-domain-matching.ts)**:
   Thuật toán khớp tên miền (`findMatchingVaultItems`).
4. **[`packages/domain/src/domain-utils.ts`](../../packages/domain/src/domain-utils.ts)**:
