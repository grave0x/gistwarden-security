...
1. **[`packages/ui/src/features/passkey/Fido2Prompt.tsx`](../../packages/ui/src/features/passkey/Fido2Prompt.tsx)**:
...
2. **[`packages/ui/src/features/passkey/fido2-service.ts`](../../packages/ui/src/features/passkey/fido2-service.ts)**:
   ...
   message phản hồi.
3. **[`packages/ui/src/features/passkey/passkey-crypto.ts`](../../packages/ui/src/features/passkey/passkey-crypto.ts)**:
   ...
   Base64URL.
4. **[`packages/ui/src/features/passkey/PasskeySelectRow.tsx`](../../packages/ui/src/features/passkey/PasskeySelectRow.tsx)**:
   Component hiển thị từng dòng Passkey trong danh sách lựa chọn.
5. **[`apps/extension/src/extension/background.ts`](../../apps/extension/src/extension/background.ts)**:
